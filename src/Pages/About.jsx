    ...
    () => [
      {
        ...
        description: "Exploring tech through diverse projects",
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p
              ...
              data-aos-duration="1500"
            >
              Mahasiswa D3 Teknik Informatika di Universitas Sangga Buana YPKP
              dengan minat kuat dalam Web Development, Game Development, dan
              teknologi modern seperti Next.js, Laravel, dan Cloud Computing.
              Memiliki dasar pengembangan aplikasi mobile dengan Kotlin dan
              Flutter. Senang mempelajari hal baru, terbiasa bekerja mandiri
              maupun dalam tim, dan siap menghadapi tantangan nyata di dunia
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="/CV - Fadhil Firdaus Adha.pdf" download className="w-full lg:w-auto">
                <button
                  data-aos="fade-up"
                  data-aos-duration="800"
